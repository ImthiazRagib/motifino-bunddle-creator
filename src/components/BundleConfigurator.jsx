    ...
    <main className="flex min-h-screen items-center justify-center px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 rounded-3xl bg-white/80 p-4 shadow-xl ring-1 ring-slate-200/80 backdrop-blur-sm sm:p-6 lg:flex-row lg:gap-8 lg:p-8">
        ...
        <section className="flex flex-col gap-4">
          ...
          <div className="mt-4">
            <StrapOptions
              fullGrainOptions={FULL_GRAIN}
              suedeOptions={SUEDE}
              veganOptions={VEGAN}
              fullGrainSelection={fullGrainSelection}
              suedeSelection={suedeSelection}
              veganSelection={veganSelection}
              onSelectFullGrain={setFullGrainSelection}
              onSelectSuede={setSuedeSelection}
              onSelectVegan={setVeganSelection}
            />
          </div>
        </section>
      </div>
